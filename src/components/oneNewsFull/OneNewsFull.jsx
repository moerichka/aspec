          ...
          <div className={s.textcontainer}>
              ...
              <div className={`${s.paragraphwrapper} ${s.main1}`}>
                <p className={s.mainparagraph}>
                  Кто подписан на нас в instagram, знает что мы активно ведем работу
                  по разработке стратегии компании. Некоторые моменты описанные в
                  ней будут для нас в новинку, так как зародились совсем недавно, но
                  что-то останется неизменным. В частности, наше участие в различных
                  социальных проектах, или так называемая социальная
                  ответственность.
                </p>
                <p className={s.mainparagraph}>
              ...
              <ol className={`${s.mainol} ${s.main2}`}>
                ...
                <li className={s.mainelem}>
                  ...
                  порядка его формирования, определение способов размещения средств
                  компенсационного фонда Ассоциации;
                </li>
              ...
              <p className={`${s.mainparagraph} ${s.main3}`}>
                ...
                флага на Берша» и т.д., были проведены работы по проектированию
                общественных пространств при участии горожан, благотворительные
                акции и другие проекты. О таких вещах мы рассказываем не часто, так
                как придерживаемся мнения, что добрые дела «любят тишину». Однако,
                иногда всё же можем себе позволить рассказать о них, к примеру, в
                день когда получаем соответствующую награду.
              </p>
          </div>
          <div className={s.mainimgwrapper}>
            <img src={contentPic} alt="" className={s.mainimg} />
          </div>
          <div className={s.textcontainer}>
              <h5 className={s.maintitle}>
                Лес начинается с тебя новые экологичные проекты для комфортной жизни
